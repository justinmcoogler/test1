...
// layer has no business knowing what 'k_count' is. js/game/lessons.js assigns a
// lesson to a room by its position in the curriculum — ninety of them, K to 8.
...
export const ROOM_COUNT = 96;     // room per lesson; add lessons, not plumbing
