  ...
  skeletal_archer: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.5, 0], boxes: [
        { from: [-0.125, 0.5, -0.125], size: [0.3125, 0.25, 0.25], uv: [0, 0, 10, 12] },        // pelvis
        { from: [-0.125, 0.6875, -0.0625], size: [0.25, 0.3125, 0.1875], uv: [12, 0, 12, 14] },       // ribcage
        { from: [-0.0625, 0.6875, -0.1875], size: [0.125, 0.3125, 0.125], uv: [0, 14, 8, 14] },        // quiver
        { from: [-0.0625, 0.875, -0.1875], size: [0.0625, 0.1875, 0.0625], uv: [10, 16, 4, 14] },       // arrow
        { from: [0, 0.875, -0.1875], size: [0.0625, 0.1875, 0.0625], uv: [10, 16, 4, 14] },        // arrow
      ] },
      { id: 'head', pivot: [0, 1, 0], boxes: [
        { from: [-0.125, 1, -0.0625], size: [0.25, 0.25, 0.25], uv: { all: [26, 0, 10, 10], south: [38, 0, 10, 10] } },
        { from: [-0.125, 0.9375, -0.0625], size: [0.1875, 0.0625, 0.1875], uv: [26, 12, 10, 4] },       // jaw
      ] },
      { id: 'arm0', pivot: [-0.1875, 1, 0], boxes: [
        { from: [-0.25, 0.5, -0.0625], size: [0.1875, 0.4375, 0.1875], uv: [38, 12, 8, 16] },
        { from: [-0.3125, 0.4375, 0.0625], size: [0.0625, 0.5625, 0.0625], uv: [48, 0, 4, 20] },          // bow
      ] },
      { id: 'arm1', pivot: [0.1875, 1, 0], boxes: [
        { from: [0.125, 0.5, -0.0625], size: [0.1875, 0.4375, 0.1875], uv: [38, 12, 8, 16] },
      ] },
      { id: 'leg0', pivot: [-0.0625, 0.5, 0], boxes: [{ from: [-0.125, 0, -0.0625], size: [0.1875, 0.5, 0.1875], uv: [48, 22, 8, 16] }] },
      { id: 'leg1', pivot: [0.0625, 0.5, 0], boxes: [{ from: [0, 0, -0.0625], size: [0.1875, 0.5, 0.1875], uv: [48, 22, 8, 16] }] },
    ],
  },
