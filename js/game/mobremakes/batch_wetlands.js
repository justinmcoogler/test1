...
export const WETLANDS = {
  ...
  marsh_wisp: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.6, 0], boxes: [
        { from: [-0.19, 0.42, -0.19], size: [0.38, 0.42, 0.38], uv: { all: [24, 0, 20, 20], south: [0, 0, 22, 22] } }, // orb
        { from: [-0.10, 0.80, -0.10], size: [0.20, 0.22, 0.20], uv: [46, 0, 12, 12] },  // crown flame
        { from: [-0.08, 0.52, 0.14], size: [0.16, 0.18, 0.10], uv: [46, 14, 10, 10] },  // core
        { from: [0.22, 0.64, 0.0], size: [0.07, 0.07, 0.07], uv: [14, 26, 8, 8] },      // motes
        { from: [-0.28, 0.50, 0.05], size: [0.06, 0.06, 0.06], uv: [14, 26, 8, 8] },
        { from: [0.06, 0.98, -0.05], size: [0.06, 0.06, 0.06], uv: [14, 26, 8, 8] },
      ] },
      { id: 'tail', parent: 'body', pivot: [0, 0.46, -0.18], boxes: [
        { from: [-0.14, 0.08, -0.16], size: [0.10, 0.34, 0.06], uv: [0, 24, 12, 24] },
        { from: [0.05, 0.04, -0.20], size: [0.09, 0.40, 0.06], uv: [0, 24, 12, 24] },
        { from: [-0.03, 0.12, -0.24], size: [0.08, 0.30, 0.05], uv: [0, 24, 12, 24] },
      ] },
    ],
  },
  ...
  will_o_wisp: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.55, 0], boxes: [
        { from: [-0.16, 0.30, -0.16], size: [0.32, 0.30, 0.32], uv: { all: [22, 0, 18, 22], south: [0, 0, 20, 24] } }, // flame base
        { from: [-0.12, 0.58, -0.12], size: [0.24, 0.26, 0.24], uv: [22, 0, 18, 22] },  // flame mid
        { from: [-0.07, 0.82, -0.07], size: [0.14, 0.22, 0.14], uv: [42, 0, 10, 12] },  // flame tip
        { from: [-0.09, 0.44, 0.08], size: [0.18, 0.20, 0.10], uv: [42, 14, 10, 10] },  // hot core
        { from: [-0.24, 0.50, -0.05], size: [0.08, 0.18, 0.10], uv: [54, 0, 8, 10] },   // tongues
        { from: [0.16, 0.50, -0.05], size: [0.08, 0.18, 0.10], uv: [54, 0, 8, 10] },
        { from: [-0.05, 0.14, -0.20], size: [0.08, 0.12, 0.08], uv: [0, 26, 10, 10] },  // trailing embers
        { from: [0.08, 0.06, -0.14], size: [0.06, 0.09, 0.06], uv: [0, 26, 10, 10] },
        { from: [-0.13, 0.20, -0.12], size: [0.05, 0.08, 0.05], uv: [0, 26, 10, 10] },
      ] },
    ],
  },
  ...
  bog_shambler: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.5, 0], boxes: [
        { from: [-0.32, 0.55, -0.28], size: [0.64, 0.62, 0.56], uv: [0, 18, 22, 20] },  // torso
        { from: [-0.28, 0.30, -0.24], size: [0.56, 0.28, 0.48], uv: [24, 18, 16, 14] }, // hips
        { from: [-0.40, 1.02, -0.12], size: [0.16, 0.12, 0.24], uv: [42, 0, 14, 12] },  // mossy shoulders
        { from: [0.24, 1.02, -0.12], size: [0.16, 0.12, 0.24], uv: [42, 0, 14, 12] },
      ] },
      { id: 'head', pivot: [0, 1.16, 0], boxes: [
        { from: [-0.22, 1.16, -0.20], size: [0.44, 0.40, 0.40], uv: { all: [16, 0, 16, 16], south: [0, 0, 16, 16] } },
        { from: [-0.14, 1.54, -0.10], size: [0.05, 0.20, 0.05], uv: [34, 0, 6, 16] },  // reed hair
        { from: [0.02, 1.54, -0.14], size: [0.05, 0.24, 0.05], uv: [34, 0, 6, 16] },
        { from: [0.10, 1.54, 0.02], size: [0.05, 0.18, 0.05], uv: [34, 0, 6, 16] },
      ] },
      { id: 'arm0', pivot: [-0.42, 1.14, 0], boxes: [{ from: [-0.52, 0.52, -0.14], size: [0.20, 0.62, 0.28], uv: [42, 20, 14, 22] }] },
      { id: 'arm1', pivot: [0.42, 1.14, 0], boxes: [{ from: [0.32, 0.52, -0.14], size: [0.20, 0.62, 0.28], uv: [42, 20, 14, 22] }] },
      { id: 'leg0', pivot: [-0.15, 0.34, 0], boxes: [{ from: [-0.26, 0, -0.14], size: [0.22, 0.34, 0.28], uv: [0, 40, 14, 20] }] },
      { id: 'leg1', pivot: [0.15, 0.34, 0], boxes: [{ from: [0.04, 0, -0.14], size: [0.22, 0.34, 0.28], uv: [0, 40, 14, 20] }] },
    ],
  },
  ...
  bog_ooze: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.3, 0], boxes: [
        { from: [-0.42, 0, -0.40], size: [0.84, 0.46, 0.80], uv: [0, 18, 28, 20] },     // base blob
        { from: [-0.30, 0.02, 0.34], size: [0.10, 0.14, 0.08], uv: [42, 28, 10, 10] },  // drips
        { from: [0.14, 0, 0.32], size: [0.09, 0.12, 0.07], uv: [42, 28, 10, 10] },
        { from: [-0.22, 0.14, 0.02], size: [0.09, 0.09, 0.09], uv: [42, 18, 8, 8] },    // pebble
      ] },
      { id: 'head', parent: 'body', pivot: [0, 0.46, 0.1], boxes: [
        { from: [-0.30, 0.46, -0.28], size: [0.60, 0.30, 0.56], uv: { all: [22, 0, 18, 14], south: [0, 0, 20, 16] } }, // dome
        { from: [-0.12, 0.76, -0.12], size: [0.24, 0.14, 0.24], uv: [42, 0, 10, 8] },   // nub
        { from: [-0.05, 0.24, 0.16], size: [0.24, 0.06, 0.07], uv: [42, 10, 14, 6] },   // suspended rib
        { from: [0.10, 0.34, -0.04], size: [0.11, 0.11, 0.11], uv: [30, 18, 10, 10] },  // skull bit
        { from: [0.04, 0.54, 0.04], size: [0.08, 0.08, 0.08], uv: [52, 18, 8, 8] },     // bubble
      ] },
    ],
  },
  ...
  grave_wight: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.5, 0], boxes: [
        { from: [-0.20, 0.42, -0.14], size: [0.40, 0.56, 0.28], uv: [0, 16, 16, 18] },  // torso
        { from: [-0.24, 0.16, -0.16], size: [0.48, 0.28, 0.32], uv: [18, 16, 20, 14] }, // shroud hem
        { from: [-0.22, 0.26, 0.14], size: [0.10, 0.24, 0.03], uv: [16, 32, 8, 14] },   // tatters
        { from: [0.12, 0.22, 0.14], size: [0.09, 0.28, 0.03], uv: [16, 32, 8, 14] },
      ] },
      { id: 'head', pivot: [0, 0.98, 0], boxes: [
        { from: [-0.16, 0.98, -0.15], size: [0.32, 0.32, 0.30], uv: { all: [16, 0, 14, 14], south: [0, 0, 14, 14] } },
        { from: [-0.18, 1.22, -0.12], size: [0.36, 0.10, 0.16], uv: [32, 0, 16, 8] },   // hood brow
      ] },
      { id: 'arm0', pivot: [-0.28, 0.94, 0], boxes: [
        { from: [-0.36, 0.40, -0.10], size: [0.13, 0.52, 0.16], uv: [40, 14, 12, 22] },
        { from: [-0.37, 0.24, 0.0], size: [0.15, 0.14, 0.16], uv: [40, 38, 12, 10] },   // grasping hand
      ] },
      { id: 'arm1', pivot: [0.28, 0.94, 0], boxes: [
        { from: [0.23, 0.40, -0.10], size: [0.13, 0.52, 0.16], uv: [40, 14, 12, 22] },
        { from: [0.22, 0.24, 0.0], size: [0.15, 0.14, 0.16], uv: [40, 38, 12, 10] },
      ] },
      { id: 'leg0', pivot: [-0.11, 0.42, 0], boxes: [{ from: [-0.18, 0, -0.10], size: [0.14, 0.42, 0.20], uv: [0, 36, 12, 18] }] },
      { id: 'leg1', pivot: [0.11, 0.42, 0], boxes: [{ from: [0.04, 0, -0.10], size: [0.14, 0.42, 0.20], uv: [0, 36, 12, 18] }] },
    ],
  },
  ...
  blight_horror: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.5, 0], boxes: [
        { from: [-0.30, 0.50, -0.24], size: [0.60, 0.64, 0.48], uv: [18, 18, 20, 20] }, // torso
        { from: [-0.26, 0.24, -0.20], size: [0.52, 0.28, 0.40], uv: [40, 18, 14, 12] }, // hips
        { from: [-0.38, 1.00, -0.12], size: [0.18, 0.22, 0.26], uv: [0, 20, 16, 16] },  // spore sacs
        { from: [0.20, 1.00, -0.12], size: [0.18, 0.22, 0.26], uv: [0, 20, 16, 16] },
      ] },
      { id: 'head', pivot: [0, 1.14, 0], boxes: [
        { from: [-0.24, 1.14, -0.22], size: [0.48, 0.46, 0.44], uv: { all: [20, 0, 16, 16], south: [0, 0, 18, 18] } },
        { from: [-0.05, 1.18, 0.20], size: [0.10, 0.34, 0.06], uv: [38, 0, 6, 16] },    // split maw
        { from: [-0.16, 1.58, -0.06], size: [0.05, 0.22, 0.05], uv: [46, 0, 6, 16] },   // antlers
        { from: [-0.24, 1.72, -0.04], size: [0.05, 0.16, 0.05], uv: [46, 0, 6, 16] },
        { from: [0.11, 1.58, -0.06], size: [0.05, 0.22, 0.05], uv: [46, 0, 6, 16] },
        { from: [0.19, 1.72, -0.04], size: [0.05, 0.16, 0.05], uv: [46, 0, 6, 16] },
      ] },
      { id: 'arm0', pivot: [-0.37, 1.12, 0], boxes: [{ from: [-0.46, 0.50, -0.15], size: [0.18, 0.60, 0.30], uv: [0, 38, 14, 22] }] },
      { id: 'arm1', pivot: [0.37, 1.12, 0], boxes: [{ from: [0.28, 0.50, -0.15], size: [0.18, 0.60, 0.30], uv: [0, 38, 14, 22] }] },
      { id: 'leg0', pivot: [-0.14, 0.32, 0], boxes: [{ from: [-0.24, 0, -0.14], size: [0.20, 0.32, 0.28], uv: [16, 38, 14, 20] }] },
      { id: 'leg1', pivot: [0.14, 0.32, 0], boxes: [{ from: [0.04, 0, -0.14], size: [0.20, 0.32, 0.28], uv: [16, 38, 14, 20] }] },
    ],
  },
  ...
  mire_toad: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.2, 0], boxes: [
        { from: [-0.34, 0.10, -0.30], size: [0.68, 0.30, 0.62], uv: { all: [0, 16, 24, 18], up: [0, 16, 24, 18] } }, // squat body
        { from: [-0.18, 0.02, 0.30], size: [0.36, 0.16, 0.18], uv: [42, 12, 14, 10] },  // throat sac
        { from: [-0.16, 0.38, -0.10], size: [0.10, 0.07, 0.10], uv: [26, 16, 8, 8] },   // warts
        { from: [0.06, 0.40, -0.16], size: [0.09, 0.06, 0.09], uv: [26, 16, 8, 8] },
        { from: [-0.03, 0.39, 0.04], size: [0.08, 0.06, 0.08], uv: [26, 16, 8, 8] },
        { from: [-0.34, 0, 0.16], size: [0.12, 0.14, 0.16], uv: [36, 24, 10, 10] },     // front legs
        { from: [0.22, 0, 0.16], size: [0.12, 0.14, 0.16], uv: [36, 24, 10, 10] },
        { from: [-0.40, 0, -0.22], size: [0.16, 0.16, 0.24], uv: [48, 24, 12, 12] },    // back legs
        { from: [0.24, 0, -0.22], size: [0.16, 0.16, 0.24], uv: [48, 24, 12, 12] },
      ] },
      { id: 'head', parent: 'body', pivot: [0, 0.14, 0.24], boxes: [
        { from: [-0.30, 0.14, 0.24], size: [0.60, 0.28, 0.30], uv: { all: [22, 0, 18, 12], south: [0, 0, 20, 14] } }, // wide head/mouth
        { from: [-0.24, 0.38, 0.28], size: [0.14, 0.12, 0.14], uv: [42, 0, 10, 10] },   // eye bulges
        { from: [0.10, 0.38, 0.28], size: [0.14, 0.12, 0.14], uv: [42, 0, 10, 10] },
      ] },
    ],
  },
};
