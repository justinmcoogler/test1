...
export const EMBER = {
  ...
  cinder_imp: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.1875, 0], boxes: [
        { from: [-0.1875, 0.25, -0.1875], size: [0.375, 0.375, 0.3125], uv: { all: [18, 18, 14, 18], south: [0, 18, 18, 18] } }, // torso
        { from: [-0.3125, 0.3125, -0.0625], size: [0.125, 0.3125, 0.125], uv: [32, 18, 8, 18] },   // arm L
        { from: [0.1875, 0.3125, -0.0625], size: [0.125, 0.3125, 0.125], uv: [32, 18, 8, 18] },    // arm R
        { from: [-0.3125, 0.5625, 0], size: [0.125, 0.125, 0.125], uv: [40, 0, 10, 10] },    // shoulder joint L
        { from: [0.1875, 0.5625, 0], size: [0.125, 0.125, 0.125], uv: [40, 0, 10, 10] },     // shoulder joint R
        { from: [-0.125, 0, -0.0625], size: [0.125, 0.25, 0.125], uv: [40, 18, 10, 18] },   // leg L
        { from: [0, 0, -0.0625], size: [0.125, 0.25, 0.125], uv: [40, 18, 10, 18] },    // leg R
        { from: [-0.125, 0.1875, 0], size: [0.125, 0.0625, 0.125], uv: [52, 0, 10, 10] }, // knee joint L
        { from: [0, 0.1875, 0], size: [0.125, 0.0625, 0.125], uv: [52, 0, 10, 10] },  // knee joint R
        { from: [-0.0625, 0.25, -0.25], size: [0.0625, 0.125, 0.1875], uv: [50, 18, 10, 14] }, // ember tail
      ] },
      { id: 'head', pivot: [0, 0.625, 0], boxes: [
        { from: [-0.1875, 0.625, -0.1875], size: [0.375, 0.3125, 0.3125], uv: { all: [16, 0, 14, 16], south: [0, 0, 16, 16] } },
        { from: [-0.125, 0.9375, -0.0625], size: [0.0625, 0.1875, 0.0625], uv: [30, 0, 8, 10] },  // horn L
        { from: [0.0625, 0.9375, -0.0625], size: [0.0625, 0.1875, 0.0625], uv: [30, 0, 8, 10] },   // horn R
      ] },
    ],
  },
  ...
  magma_hulk: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.375, 0], boxes: [
        { from: [-0.3125, 0.5, -0.1875], size: [0.625, 0.75, 0.375], uv: { all: [22, 18, 16, 22], south: [0, 18, 22, 22] } }, // torso
        { from: [-0.125, 0.6875, 0.1875], size: [0.1875, 0.4375, 0.0625], uv: [46, 0, 10, 16] },    // chest lava seam
        { from: [-0.25, 0.375, -0.1875], size: [0.5625, 0.1875, 0.375], uv: [28, 40, 20, 10] }, // pelvis
        { from: [-0.4375, 1, -0.1875], size: [0.8125, 0.1875, 0.375], uv: [38, 18, 12, 12] },  // shoulder crust shelf
        { from: [-0.3125, 1.0625, -0.25], size: [0.25, 0.1875, 0.125], uv: [38, 18, 12, 12] }, // back plate L
        { from: [0.0625, 1.0625, -0.25], size: [0.25, 0.1875, 0.125], uv: [38, 18, 12, 12] }, // back plate R
      ] },
      { id: 'head', pivot: [0, 1.125, 0], boxes: [
        { from: [-0.1875, 1.125, -0.1875], size: [0.375, 0.3125, 0.3125], uv: { all: [16, 0, 14, 16], south: [0, 0, 16, 16] } },
        { from: [-0.25, 1.4375, -0.125], size: [0.4375, 0.125, 0.1875], uv: [30, 0, 16, 8] },    // brow crust
      ] },
      { id: 'arm0', pivot: [-0.4375, 1.125, 0], boxes: [{ from: [-0.6875, 0.5, -0.1875], size: [0.25, 0.625, 0.3125], uv: [0, 40, 14, 22] }] },
      { id: 'arm1', pivot: [0.4375, 1.125, 0], boxes: [{ from: [0.4375, 0.5, -0.1875], size: [0.25, 0.625, 0.3125], uv: [0, 40, 14, 22] }] },
      { id: 'leg0', pivot: [-0.125, 0.4375, 0], boxes: [{ from: [-0.25, 0, -0.1875], size: [0.25, 0.4375, 0.3125], uv: [14, 40, 14, 22] }] },
      { id: 'leg1', pivot: [0.125, 0.4375, 0], boxes: [{ from: [0, 0, -0.1875], size: [0.25, 0.4375, 0.3125], uv: [14, 40, 14, 22] }] },
    ],
  },
  ...
  veil_crawler: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.3125, 0], boxes: [
        { from: [-0.25, 0.25, 0.0625], size: [0.4375, 0.3125, 0.5], uv: [0, 18, 24, 18] },    // body front
        { from: [-0.1875, 0.25, -0.5], size: [0.375, 0.25, 0.5625], uv: [24, 18, 24, 18] },   // body rear
        { from: [-0.0625, 0.5, 0.25], size: [0.125, 0.25, 0.125], uv: [40, 0, 8, 16] },      // crystal spine
        { from: [-0.0625, 0.5, 0.0625], size: [0.125, 0.25, 0.125], uv: [40, 0, 8, 16] },
        { from: [-0.0625, 0.5, -0.1875], size: [0.125, 0.25, 0.125], uv: [40, 0, 8, 16] },
        { from: [-0.0625, 0.5, -0.375], size: [0.125, 0.1875, 0.125], uv: [40, 0, 8, 16] },
      ] },
      { id: 'head', pivot: [0, 0.3125, 0.5], boxes: [
        { from: [-0.1875, 0.25, 0.5], size: [0.375, 0.3125, 0.3125], uv: { all: [16, 0, 14, 16], south: [0, 0, 16, 16] } },
        { from: [-0.125, 0.25, 0.75], size: [0.25, 0.1875, 0.125], uv: [30, 0, 10, 8] },   // maw
      ] },
      { id: 'leg0', pivot: [-0.25, 0.3125, 0.3125], boxes: [{ from: [-0.3125, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'leg1', pivot: [0.25, 0.3125, 0.3125], boxes: [{ from: [0.25, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'leg2', pivot: [-0.25, 0.3125, 0], boxes: [{ from: [-0.3125, 0, -0.0625], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'leg3', pivot: [0.25, 0.3125, 0], boxes: [{ from: [0.25, 0, -0.0625], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'leg4', pivot: [-0.25, 0.3125, -0.375], boxes: [{ from: [-0.3125, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'leg5', pivot: [0.25, 0.3125, -0.375], boxes: [{ from: [0.25, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [0, 38, 10, 18] }] },
      { id: 'tail', pivot: [0, 0.3125, -0.5], boxes: [{ from: [-0.0625, 0.3125, -0.75], size: [0.125, 0.125, 0.3125], uv: [48, 18, 8, 14] }] },
    ],
  },
  ...
  gloomrat: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.125, 0], boxes: [
        { from: [-0.1875, 0.125, -0.25], size: [0.3125, 0.25, 0.5], uv: { all: [0, 16, 22, 14], up: [22, 16, 14, 14] } },
        { from: [-0.125, 0.125, -0.3125], size: [0.3125, 0.25, 0.25], uv: [22, 16, 14, 14] }, // haunch
        { from: [-0.125, 0, 0.125], size: [0.0625, 0.125, 0.0625], uv: [0, 32, 8, 12] },      // front legs
        { from: [0.0625, 0, 0.125], size: [0.0625, 0.125, 0.0625], uv: [0, 32, 8, 12] },
        { from: [-0.125, 0, -0.25], size: [0.0625, 0.125, 0.0625], uv: [0, 32, 8, 12] },     // hind legs
        { from: [0.0625, 0, -0.25], size: [0.0625, 0.125, 0.0625], uv: [0, 32, 8, 12] },
      ] },
      { id: 'head', pivot: [0, 0.1875, 0.1875], boxes: [
        { from: [-0.125, 0.125, 0.25], size: [0.25, 0.25, 0.25], uv: { all: [14, 0, 12, 14], south: [0, 0, 14, 14] } },
        { from: [-0.0625, 0.125, 0.4375], size: [0.125, 0.125, 0.125], uv: [26, 0, 8, 8] },    // snout
        { from: [-0.125, 0.375, 0.25], size: [0.125, 0.125, 0.0625], uv: [34, 0, 8, 8] },    // ear L (notched)
        { from: [0.0625, 0.375, 0.25], size: [0.125, 0.125, 0.0625], uv: [34, 0, 8, 8] },     // ear R
      ] },
      { id: 'tail', pivot: [0, 0.1875, -0.375], boxes: [{ from: [0, 0.125, -0.4375], size: [0.0625, 0.0625, 0.4375], uv: [36, 16, 10, 8] }] },
    ],
  },
  ...
  root_creeper: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.1875, 0], boxes: [
        { from: [-0.25, 0, -0.25], size: [0.5, 0.25, 0.5], uv: [0, 18, 24, 16] },    // base root mass
        { from: [-0.1875, 0.1875, -0.1875], size: [0.375, 0.3125, 0.375], uv: [24, 18, 20, 18] },     // mid body
        // four splayed root legs (thigh out + shin down)
        { from: [-0.4375, 0.1875, 0.125], size: [0.1875, 0.125, 0.125], uv: [0, 38, 14, 10] },
        { from: [-0.4375, 0, 0.125], size: [0.125, 0.1875, 0.125], uv: [14, 38, 10, 18] },
        { from: [0.25, 0.1875, 0.125], size: [0.1875, 0.125, 0.125], uv: [0, 38, 14, 10] },
        { from: [0.375, 0, 0.125], size: [0.125, 0.1875, 0.125], uv: [14, 38, 10, 18] },
        { from: [-0.4375, 0.1875, -0.25], size: [0.1875, 0.125, 0.125], uv: [0, 38, 14, 10] },
        { from: [-0.4375, 0, -0.25], size: [0.125, 0.1875, 0.125], uv: [14, 38, 10, 18] },
        { from: [0.25, 0.1875, -0.25], size: [0.1875, 0.125, 0.125], uv: [0, 38, 14, 10] },
        { from: [0.375, 0, -0.25], size: [0.125, 0.1875, 0.125], uv: [14, 38, 10, 18] },
      ] },
      { id: 'head', pivot: [0, 0.5, -0.125], boxes: [
        { from: [-0.125, 0.5, -0.125], size: [0.3125, 0.25, 0.3125], uv: { all: [16, 0, 14, 16], south: [0, 0, 16, 16] } },
        { from: [-0.0625, 0.75, -0.0625], size: [0.125, 0.1875, 0.125], uv: [30, 0, 10, 14] },   // sprout
      ] },
    ],
  },
  ...
  rootling: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.125, 0], boxes: [
        { from: [-0.125, 0, -0.125], size: [0.3125, 0.3125, 0.3125], uv: [0, 18, 18, 18] },       // root bulb
        { from: [-0.125, 0, 0], size: [0.0625, 0.125, 0.125], uv: [18, 18, 10, 12] },      // foot L
        { from: [0, 0, 0], size: [0.0625, 0.125, 0.125], uv: [18, 18, 10, 12] },       // foot R
        { from: [-0.1875, 0.125, 0], size: [0.0625, 0.125, 0.0625], uv: [28, 18, 8, 14] },     // arm L
        { from: [0.125, 0.125, 0], size: [0.0625, 0.125, 0.0625], uv: [28, 18, 8, 14] },       // arm R
      ] },
      { id: 'head', pivot: [0, 0.3125, 0], boxes: [
        { from: [-0.125, 0.3125, -0.125], size: [0.25, 0.25, 0.25], uv: { all: [16, 0, 14, 16], south: [0, 0, 16, 16] } },
        { from: [-0.0625, 0.4375, 0.0625], size: [0.125, 0.125, 0.0625], uv: [30, 0, 10, 14] },   // leaf front
        { from: [-0.0625, 0.4375, -0.0625], size: [0.125, 0.125, 0.0625], uv: [30, 0, 10, 14] },  // leaf back
        { from: [-0.125, 0.4375, 0], size: [0.0625, 0.125, 0.125], uv: [30, 0, 10, 14] },  // leaf L
        { from: [0.0625, 0.4375, 0], size: [0.0625, 0.125, 0.125], uv: [30, 0, 10, 14] },   // leaf R
      ] },
    ],
  },
  ...
  ash_salamander: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.125, 0], boxes: [
        { from: [-0.125, 0.0625, -0.25], size: [0.25, 0.25, 0.5], uv: { all: [0, 14, 24, 14], up: [24, 14, 24, 14] } },
        { from: [0, 0.25, 0.0625], size: [0.0625, 0.0625, 0.125], uv: [36, 0, 8, 8] },     // dorsal ember ridge
        { from: [0, 0.25, -0.1875], size: [0.0625, 0.0625, 0.125], uv: [36, 0, 8, 8] },
        { from: [-0.25, 0, 0.0625], size: [0.125, 0.0625, 0.125], uv: [30, 30, 12, 8] },    // front legs (sprawled)
        { from: [0.125, 0, 0.0625], size: [0.125, 0.0625, 0.125], uv: [30, 30, 12, 8] },
        { from: [-0.25, 0, -0.25], size: [0.125, 0.0625, 0.125], uv: [30, 30, 12, 8] },   // hind legs
        { from: [0.125, 0, -0.25], size: [0.125, 0.0625, 0.125], uv: [30, 30, 12, 8] },
      ] },
      { id: 'head', pivot: [0, 0.125, 0.25], boxes: [
        { from: [-0.125, 0.0625, 0.25], size: [0.25, 0.25, 0.25], uv: { all: [14, 0, 12, 12], south: [0, 0, 14, 12] } },
        { from: [-0.0625, 0.0625, 0.5], size: [0.1875, 0.125, 0.125], uv: [26, 0, 10, 8] },     // snout
      ] },
      { id: 'tail', pivot: [0, 0.125, -0.25], boxes: [
        { from: [-0.0625, 0.0625, -0.5625], size: [0.125, 0.125, 0.375], uv: [0, 30, 18, 12] },
        { from: [0, 0.0625, -0.8125], size: [0.0625, 0.0625, 0.25], uv: [18, 30, 12, 10] },
      ] },
    ],
  },
};
