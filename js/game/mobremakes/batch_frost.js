...
export const FROST = {
  ...
  frostmaw_wolf: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.5, 0], boxes: [
        { from: [-0.25, 0.3125, -0.5625], size: [0.5, 0.5, 1], uv: { all: [0, 16, 26, 20], up: [26, 16, 22, 14] } },
        { from: [-0.25, 0.5, 0.125], size: [0.5625, 0.25, 0.4375], uv: [0, 38, 24, 12] }, // shoulder ruff
      ] },
      { id: 'head', pivot: [0, 0.5625, 0.4375], boxes: [
        { from: [-0.1875, 0.5, 0.4375], size: [0.375, 0.375, 0.4375], uv: { all: [14, 0, 14, 14], south: [0, 0, 14, 14] } },
        { from: [-0.125, 0.5, 0.8125], size: [0.25, 0.1875, 0.25], uv: [28, 0, 10, 9] },   // snout
        { from: [-0.0625, 0.5625, 1.0625], size: [0.125, 0.125, 0.125], uv: [46, 0, 12, 10] }, // frost breath
        { from: [-0.1875, 0.875, 0.5], size: [0.125, 0.1875, 0.0625], uv: [38, 0, 7, 7] },      // ears
        { from: [0.0625, 0.875, 0.5], size: [0.125, 0.1875, 0.0625], uv: [38, 0, 7, 7] },
      ] },
      { id: 'leg0', pivot: [-0.1875, 0.3125, 0.3125], boxes: [{ from: [-0.25, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [34, 38, 12, 16] }] },
      { id: 'leg1', pivot: [0.1875, 0.3125, 0.3125], boxes: [{ from: [0.125, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [34, 38, 12, 16] }] },
      { id: 'leg2', pivot: [-0.1875, 0.3125, -0.3125], boxes: [{ from: [-0.25, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [34, 38, 12, 16] }] },
      { id: 'leg3', pivot: [0.1875, 0.3125, -0.3125], boxes: [{ from: [0.125, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [34, 38, 12, 16] }] },
      { id: 'tail', pivot: [0, 0.5, -0.5625], boxes: [{ from: [-0.0625, 0.375, -0.75], size: [0.125, 0.1875, 0.3125], uv: [24, 38, 10, 12] }] },
    ],
  },
  ...
  rime_shade: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.625, 0], boxes: [
        { from: [-0.25, 0.3125, -0.1875], size: [0.4375, 0.75, 0.3125], uv: [0, 16, 24, 26] },     // robe
        { from: [-0.125, 0.0625, -0.125], size: [0.25, 0.25, 0.25], uv: [24, 16, 14, 14] },   // lower wisp
        { from: [-0.0625, 0, -0.0625], size: [0.1875, 0.125, 0.1875], uv: [38, 16, 10, 10] },    // tatter tip
        { from: [-0.25, 1, -0.1875], size: [0.5, 0.1875, 0.3125], uv: [0, 44, 24, 12] },     // shoulders
        { from: [-0.3125, 0.5, -0.0625], size: [0.125, 0.5625, 0.1875], uv: [24, 44, 8, 18] },      // ice veil L
        { from: [0.25, 0.5, -0.0625], size: [0.125, 0.5625, 0.1875], uv: [24, 44, 8, 18] },       // ice veil R
        { from: [-0.1875, 0.3125, 0.125], size: [0.3125, 0.5, 0.0625], uv: [34, 30, 16, 22] },     // front drape
      ] },
      { id: 'head', pivot: [0, 1.125, 0], boxes: [
        { from: [-0.1875, 1.125, -0.125], size: [0.375, 0.3125, 0.3125], uv: { all: [0, 0, 16, 16], south: [16, 0, 16, 16] } }, // cowl
        { from: [-0.125, 1.1875, 0], size: [0.25, 0.25, 0.0625], uv: [16, 0, 16, 16] },     // void face
        { from: [-0.0625, 1.4375, -0.0625], size: [0.125, 0.125, 0.1875], uv: [34, 0, 10, 10] },    // hood peak
      ] },
    ],
  },
  ...
  bone_hound: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.4375, 0], boxes: [
        { from: [-0.1875, 0.375, -0.375], size: [0.375, 0.25, 0.75], uv: { all: [0, 16, 24, 18], up: [24, 16, 16, 14] } }, // ribcage
        { from: [-0.1875, 0.375, -0.5], size: [0.3125, 0.25, 0.25], uv: [40, 16, 10, 14] },  // pelvis
      ] },
      { id: 'head', pivot: [0, 0.4375, 0.4375], boxes: [
        { from: [-0.125, 0.375, 0.4375], size: [0.3125, 0.3125, 0.3125], uv: { all: [14, 0, 14, 14], south: [0, 0, 14, 14] } }, // skull
        { from: [-0.125, 0.375, 0.75], size: [0.1875, 0.1875, 0.1875], uv: [28, 0, 10, 8] },      // snout/jaw
      ] },
      { id: 'leg0', pivot: [-0.125, 0.3125, 0.3125], boxes: [{ from: [-0.1875, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [36, 38, 10, 16] }] },
      { id: 'leg1', pivot: [0.125, 0.3125, 0.3125], boxes: [{ from: [0.0625, 0, 0.25], size: [0.1875, 0.3125, 0.1875], uv: [36, 38, 10, 16] }] },
      { id: 'leg2', pivot: [-0.125, 0.3125, -0.3125], boxes: [{ from: [-0.1875, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [36, 38, 10, 16] }] },
      { id: 'leg3', pivot: [0.125, 0.3125, -0.3125], boxes: [{ from: [0.0625, 0, -0.375], size: [0.1875, 0.3125, 0.1875], uv: [36, 38, 10, 16] }] },
      { id: 'tail', pivot: [0, 0.4375, -0.5], boxes: [{ from: [-0.0625, 0.4375, -0.75], size: [0.0625, 0.0625, 0.3125], uv: [24, 38, 10, 10] }] },
    ],
  },
  ...
  frost_elemental: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.375, 0], boxes: [
        { from: [-0.25, 0.4375, -0.1875], size: [0.5, 0.5625, 0.3125], uv: { all: [16, 0, 14, 18], south: [0, 0, 16, 18] } }, // torso
        { from: [-0.125, 0.625, 0.125], size: [0.25, 0.25, 0.0625], uv: [30, 0, 12, 12] },   // frozen core
        { from: [-0.0625, 1, -0.0625], size: [0.1875, 0.3125, 0.125], uv: [42, 0, 10, 14] },  // back shard L
        { from: [0, 1, -0.0625], size: [0.125, 0.25, 0.125], uv: [42, 0, 10, 14] },   // back shard R
      ] },
      { id: 'head', pivot: [0, 1, 0], boxes: [
        { from: [-0.1875, 1, -0.125], size: [0.3125, 0.3125, 0.3125], uv: { all: [14, 20, 12, 14], south: [0, 20, 14, 14] } }, // head crystal
        { from: [-0.0625, 1.25, -0.0625], size: [0.1875, 0.25, 0.1875], uv: [26, 20, 8, 16] }, // crown shard
      ] },
      { id: 'arm0', pivot: [-0.3125, 1, 0], boxes: [{ from: [-0.375, 0.5, -0.0625], size: [0.1875, 0.5, 0.1875], uv: [36, 20, 10, 20] }] },
      { id: 'arm1', pivot: [0.3125, 1, 0], boxes: [{ from: [0.25, 0.5, -0.0625], size: [0.1875, 0.5, 0.1875], uv: [36, 20, 10, 20] }] },
      { id: 'leg0', pivot: [-0.125, 0.4375, 0], boxes: [{ from: [-0.25, 0, -0.0625], size: [0.1875, 0.4375, 0.1875], uv: [46, 20, 12, 22] }] },
      { id: 'leg1', pivot: [0.125, 0.4375, 0], boxes: [{ from: [0.0625, 0, -0.0625], size: [0.1875, 0.4375, 0.1875], uv: [46, 20, 12, 22] }] },
    ],
  },
  ...
  gaze_orb: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.6875, 0], boxes: [
        { from: [-0.25, 0.5, -0.25], size: [0.5625, 0.5625, 0.5], uv: { all: [0, 0, 18, 18], south: [18, 0, 22, 22] } }, // orb + eye
        { from: [-0.1875, 0.5625, 0.25], size: [0.375, 0.375, 0.0625], uv: [40, 0, 14, 14] },   // iris protrusion
        { from: [-0.3125, 0.875, -0.25], size: [0.625, 0.125, 0.5], uv: [0, 22, 22, 12] },   // stone lid top
        { from: [-0.3125, 0.4375, -0.25], size: [0.625, 0.125, 0.5], uv: [0, 22, 22, 12] },   // stone lid bottom
        // stone lashes around the eye
        { from: [-0.25, 0.8125, 0.1875], size: [0.125, 0.125, 0.125], uv: [24, 22, 8, 12] },
        { from: [-0.0625, 0.875, 0.1875], size: [0.125, 0.125, 0.125], uv: [24, 22, 8, 12] },
        { from: [0.1875, 0.8125, 0.1875], size: [0.125, 0.125, 0.125], uv: [24, 22, 8, 12] },
        { from: [-0.25, 0.5, 0.1875], size: [0.125, 0.125, 0.125], uv: [24, 22, 8, 12] },
        { from: [0.1875, 0.5, 0.1875], size: [0.125, 0.125, 0.125], uv: [24, 22, 8, 12] },
        // trailing tendrils below
        { from: [-0.1875, 0.25, -0.0625], size: [0.125, 0.25, 0.125], uv: [34, 22, 8, 16] },
        { from: [0.0625, 0.25, -0.0625], size: [0.125, 0.3125, 0.125], uv: [44, 16, 8, 18] },
      ] },
    ],
  },
  ...
  hollow_watcher: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.625, 0], boxes: [
        { from: [-0.25, 0.125, -0.125], size: [0.4375, 0.6875, 0.3125], uv: [0, 16, 22, 26] },   // robe
        { from: [-0.125, 0, -0.125], size: [0.25, 0.125, 0.25], uv: [22, 16, 12, 12] },  // lower drift
        { from: [-0.0625, 0, -0.0625], size: [0.1875, 0.125, 0.125], uv: [34, 16, 10, 10] }, // tatter
        { from: [-0.25, 0.6875, -0.125], size: [0.5, 0.1875, 0.3125], uv: [0, 44, 22, 12] }, // shoulders
        { from: [-0.25, 0.25, -0.0625], size: [0.125, 0.375, 0.1875], uv: [24, 44, 8, 18] },  // sleeve L
        { from: [0.1875, 0.25, -0.0625], size: [0.125, 0.375, 0.1875], uv: [24, 44, 8, 18] },   // sleeve R
        { from: [-0.1875, 0.1875, 0.125], size: [0.3125, 0.4375, 0.0625], uv: [34, 30, 16, 20] },  // front veil
      ] },
      { id: 'head', pivot: [0, 0.8125, 0], boxes: [
        { from: [-0.1875, 0.75, -0.125], size: [0.375, 0.3125, 0.3125], uv: { all: [0, 0, 16, 16], south: [16, 0, 16, 16] } }, // hood
        { from: [-0.125, 0.8125, 0], size: [0.25, 0.25, 0.0625], uv: [16, 0, 16, 16] },  // void face
        { from: [-0.0625, 1.0625, -0.0625], size: [0.125, 0.125, 0.1875], uv: [34, 0, 10, 10] }, // hood peak
      ] },
    ],
  },
  ...
  snow_hare: {
    ...
    parts: [
      { id: 'body', pivot: [0, 0.1875, 0], boxes: [
        { from: [-0.125, 0.125, -0.25], size: [0.25, 0.25, 0.375], uv: { all: [0, 16, 22, 16], up: [22, 16, 14, 14] } },
        { from: [-0.125, 0.125, -0.3125], size: [0.3125, 0.25, 0.25], uv: [22, 16, 14, 14] },  // haunch
        { from: [-0.125, 0, 0.125], size: [0.0625, 0.1875, 0.125], uv: [46, 16, 10, 12] },     // front paw L
        { from: [0, 0, 0.125], size: [0.0625, 0.1875, 0.125], uv: [46, 16, 10, 12] },      // front paw R
        { from: [-0.125, 0, -0.1875], size: [0.125, 0.125, 0.1875], uv: [46, 16, 10, 12] },     // hind foot L
        { from: [0, 0, -0.1875], size: [0.125, 0.125, 0.1875], uv: [46, 16, 10, 12] },      // hind foot R
      ] },
      { id: 'head', pivot: [0, 0.1875, 0.125], boxes: [
        { from: [-0.125, 0.1875, 0.125], size: [0.25, 0.25, 0.25], uv: { all: [14, 0, 14, 14], south: [0, 0, 14, 14] } },
        { from: [-0.125, 0.375, 0.125], size: [0.0625, 0.25, 0.0625], uv: [28, 0, 8, 14] },     // ear L
        { from: [0.0625, 0.375, 0.125], size: [0.0625, 0.25, 0.0625], uv: [28, 0, 8, 14] },     // ear R
      ] },
      { id: 'tail', pivot: [0, 0.1875, -0.3125], boxes: [{ from: [-0.0625, 0.1875, -0.375], size: [0.125, 0.125, 0.125], uv: [36, 16, 10, 10] }] },
    ],
  },
};
