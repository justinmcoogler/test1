...
export const SKILL_DEFS = {
  // Gathering
  mining:      { label: 'Mining', icon: '⛏️', group: 'Gathering', desc: 'Break ore veins and stone for metals and minerals.' },
  woodcutting: { label: 'Woodcutting', icon: '🪓', group: 'Gathering', desc: 'Fell trees for timber and rare saps.' },
  fishing:     { label: 'Fishing', icon: '🎣', group: 'Gathering', desc: 'Catch fish from spots in ponds, rivers and coasts.' },
  foraging:    { label: 'Foraging', icon: '🌿', group: 'Gathering', desc: 'Harvest herbs, berries and wild plants.' },
  hunting:     { label: 'Hunting', icon: '🏹', group: 'Gathering', desc: 'Track and bring down wild creatures for hide and meat.' },
  farming:     { label: 'Farming', icon: '🌾', group: 'Gathering', desc: 'Sow, tend and harvest crops in tilled plots.' },
  archaeology: { label: 'Archaeology', icon: '🏺', group: 'Gathering', desc: 'Excavate dig sites for relics of the old world.' },
  // Processing & crafting
  smithing:     { label: 'Smithing', icon: '🔨', group: 'Crafting', desc: 'Smelt bars and forge metal tools, weapons and armor.' },
  woodworking:  { label: 'Woodworking', icon: '🪚', group: 'Crafting', desc: 'Shape timber into planks, hafts, bows and furniture.' },
  cooking:      { label: 'Cooking', icon: '🍳', group: 'Crafting', desc: 'Turn raw food into hearty meals.' },
  tailoring:    { label: 'Tailoring', icon: '🧵', group: 'Crafting', desc: 'Weave cloth and stitch hides into armor.' },
  alchemy:      { label: 'Alchemy', icon: '⚗️', group: 'Crafting', desc: 'Brew tonics and salves from herbs.' },
  construction: { label: 'Construction', icon: '🏗️', group: 'Crafting', desc: 'Build structures, stations and settlements.' },
  enchanting:   { label: 'Enchanting', icon: '🔮', group: 'Crafting', desc: 'Bind crystal energies into charms and gear.' },
  // Combat
  vitality: { label: 'Vitality', icon: '❤️', group: 'Combat', desc: 'Raises maximum health.' },
  strength: { label: 'Strength', icon: '💪', group: 'Combat', desc: 'Melee damage and carrying power.' },
  defense:  { label: 'Defense', icon: '🛡️', group: 'Combat', desc: 'Reduces damage taken; improves guarding.' },
  ranged:   { label: 'Ranged', icon: '🎯', group: 'Combat', desc: 'Accuracy and damage with bows and thrown weapons.' },
  magic:    { label: 'Magic', icon: '✨', group: 'Combat', desc: 'Spell damage, mana and elemental arts.' },
  healing:  { label: 'Healing', icon: '💚', group: 'Combat', desc: 'Restorative arts, in and out of battle.' },
  tactics:  { label: 'Tactics', icon: '🧠', group: 'Combat', desc: 'Initiative, inspection and battlefield cunning.' },
};
